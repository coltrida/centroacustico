...
Route::get('/setTipologie', [FrontController::class, 'setTipologie'])->name('setTipologie');
Route::post('/setTipologie', [FrontController::class, 'eseguiSetTipologie'])->name('eseguiSetTipologie');
...
Route::post('/associa', [FrontController::class, 'eseguiAssocia'])->name('admin.eseguiAssocia');
Route::get('/eliminaAssociazione/{idAssociazione}', [FrontController::class, 'eliminaAssociazione'])->name('admin.eliminaAssociazione');
Route::get('/ricercaPaziente', [FrontController::class, 'ricercaPaziente'])->name('admin.ricercaPaziente');
