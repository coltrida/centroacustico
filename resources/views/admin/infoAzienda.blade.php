        ...
        <div
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <form action="{{route('admin.modificaInfoAzienda')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('patch')
                    <div class="mt-8 mb-4 bg-white dark:bg-gray-800 overflow-hidden sm:rounded-lg p-4">
                            ...
                            <div class="p-6 col">
                                ...
                                <div class="ml-1 mb-3">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="nomeAzienda" class="form-control"
                                                   value="{{$configurazione->nomeAzienda}}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="indirizzoAzienda" class="form-control"
                                                   value="{{$configurazione->indirizzoAzienda}}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="cittaAzienda" class="form-control"
                                                   value="{{$configurazione->cittaAzienda}}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="provinciaAzienda" class="form-control"
                                                   value="{{$configurazione->provinciaAzienda}}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="pivaAzienda" class="form-control"
                                                   value="{{$configurazione->pivaAzienda}}"
                            ...
                            <div class="p-6 col">
                                ...
                                <div class="ml-1 mb-4">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="emailAzienda" class="form-control"
                                                   value="{{$configurazione->emailAzienda}}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="pecAzienda" class="form-control"
                                                   value="{{$configurazione->pecAzienda}}"
                                                   placeholder="pec Azienda" aria-label="First name">
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <label for="telefonoAzienda" class="col-sm-3 col-form-label">telefono
                                            Azienda</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="telefonoAzienda" class="form-control"
                                                   value="{{$configurazione->telefonoAzienda}}"
                                                   placeholder="pec Azienda" aria-label="First name">
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="magazzinoCentralizzato"
                                                   ...
                                                   value='1' {{$configurazione->magazzinoCentralizzato == 1 ? 'checked' : ''}}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="magazzinoCentralizzato"
                                                   ...
                                                   value='0' {{$configurazione->magazzinoCentralizzato == 0 ? 'checked' : ''}}>
