                                ...
                                <div class="ml-1 mb-3">
                                    <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="magazzinoBool" id="flexRadioDefault1" value='1'>
                                            <label class="form-check-label" for="flexRadioDefault1">
                                                Magazzino centrale + magazzini delle filiali
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="magazzinoBool" id="flexRadioDefault2" value='0'>
