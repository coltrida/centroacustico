        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <label for="inputPassword6" class="col-form-label">Tipo Visita</label>
                        </div>
                        <div class="col-9">
                    ...
                    <div class="row">
                        <div class="col-3">
                            <label for="inputPassword6" class="col-form-label">Orario Visita</label>
                        </div>
                        <div class="col-9">
                            <input type="time" class="form-control mb-4" name="" id="orario" readonly>
                        </div>
                    </div>
